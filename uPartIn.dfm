object frmPartIn: TfrmPartIn
  Left = 207
  Top = 121
  BorderStyle = bsSingle
  Caption = #48512#54408#51077#44256#46321#47197
  ClientHeight = 589
  ClientWidth = 862
  Color = clBtnFace
  ...
  object Label10: TLabel
    ...
    Height = 13
    AutoSize = False
    Caption = #51077#44256#52376#47532#51068
  end
  ...
  object GroupBox1: TGroupBox
    ...
    object Label4: TLabel
      ...
      Height = 13
      AutoSize = False
      Caption = #51077#44256#44079#49688
    end
    object Label5: TLabel
      ...
      Height = 13
      AutoSize = False
      Caption = #44396#51077#50896#44552
    end
    object Label1: TLabel
      ...
      Height = 13
      AutoSize = False
      Caption = #44396#51077#52376#53076#46300
    end
    object Label2: TLabel
      ...
      Height = 13
      AutoSize = False
      Caption = #51648#48520#44552#50529
    end
    object Label3: TLabel
      ...
      Height = 13
      AutoSize = False
      Caption = #48120#51648#44553#44552#50529
    end
    ...
    object Label7: TLabel
      ...
      Height = 13
      AutoSize = False
      Caption = #44396#51077#52376#51060#47492
    end
    object Edit2: TEdit
      Left = 104
      Top = 52
    ...
    object DBGrid2: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'in_seq'
          Title.Caption = #51077#44256#49692#48264
          Visible = True
        end
        item
          Expanded = False
  ...
  object Table1: TTable
    ...
    object Table1IN_DATE: TDateField
      FieldName = 'IN_DATE'
    end
    object Table1IN_SEQ: TFloatField
      FieldName = 'IN_SEQ'
    end
    object Table1IN_CNT: TFloatField
      FieldName = 'IN_CNT'
    end
    object Table1IN_AMT: TFloatField
      FieldName = 'IN_AMT'
    end
  ...
  object Query2: TQuery
    DatabaseName = 'KorInsDB'
    SQL.Strings = (
      'select part_id, part_name, part_get_price from part')
    Left = 200
    Top = 40
    ...
    object Query2part_get_price: TFloatField
  ...
  object qrySeq: TQuery
    DatabaseName = 'KorInsDB'
    SQL.Strings = (
      'select max(in_seq) +1 as nextseq from partin'
  ...
  object qryResult: TQuery
    DatabaseName = 'KorInsDB'
    SQL.Strings = (
      'select part_id, in_date, in_seq, in_cnt'
      'from partin'
      'where part_id = :part_id'
      'and in_date = :in_date')
    Left = 632
    ...
    object qryResultin_date: TDateField
      FieldName = 'in_date'
      Origin = 'KORINSDB."PARTIN.DB".IN_DATE'
    end
    object qryResultin_seq: TFloatField
      FieldName = 'in_seq'
      Origin = 'KORINSDB."PARTIN.DB".IN_SEQ'
    end
    object qryResultin_cnt: TFloatField
      FieldName = 'in_cnt'
      Origin = 'KORINSDB."PARTIN.DB".IN_CNT'
    end
  end
